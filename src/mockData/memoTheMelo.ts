...
const memoTheMeloMockData: MemoTheMeloGame = [
    ...
    [
        ...
        {
            pitchOptions: ['622.25', '698.46', '830.61', '1108.73'],
            melody: [0, 2, 1, 3, 0],
        },
        {
        ...
        {
            pitchOptions: ['349.23', '440.00', '523.25', '622.25'],
            melody: [1, 2, 3, 0, 3, 1],
        },
        {
            pitchOptions: ['783.99', '987.77', '1174.66', '1396.91'],
            melody: [1, 2, 3, 0, 3, 1],
        },
        {
        ...
        {
            pitchOptions: ['440.00', '493.88', '523.25', '659.25'],
            melody: [1, 2, 3, 0, 3, 1],
        },
        {
            pitchOptions: ['196.00', '261.63', '293.66', '329.63'],
